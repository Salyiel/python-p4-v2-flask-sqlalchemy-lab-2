...
class Customer(db.Model, SerializerMixin):
    ...
    # Exclude reviews.customer to prevent recursive serialization
...
class Item(db.Model,SerializerMixin):
    ...
    # Exclude reviews.item to prevent recursive serialization
...
class Review(db.Model, SerializerMixin):
    ...
    # Exclude customer.reviews and item.reviews to prevent recursive serialization
